...
```bash
venv/bin/pytest tests/screener/ --collect-only -q
```
...
```bash
venv/bin/pytest tests/screener/test_overlay.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_universe_override.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_registry.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_coiled.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_persistence.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_persistence.py -v -k backfill
```
...
```bash
venv/bin/pytest tests/screener/test_runner.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_bars.py -v
```
...
```bash
venv/bin/pytest tests/screener/test_endpoints.py -v
```
...
```bash
venv/bin/pytest tests/screener/ -v
```
